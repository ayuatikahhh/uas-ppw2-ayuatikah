        ...
        <div class="mx-auto max-w-screen-xl">
            <form action="{{ route('pegawai.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="telepon" value="{{ old('telepon') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required>
                </div>
                <div>
